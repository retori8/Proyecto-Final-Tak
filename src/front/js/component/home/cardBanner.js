...
export const CardBanner = () => {
    return (
        <div id="cardbanner" className="container col-10 row" style={{ background: "none", border: "solid red 5px" }}>
            <div id="cardbody" className="card mb-3" style={{ background: "none" }}>
                <div className="row g-0" style={{ background: "none" }}>
                    <div className="col-md-8" style={{ background: "none" }}>
                        <div className="card-body ps-4" style={{ background: "none" }}>
